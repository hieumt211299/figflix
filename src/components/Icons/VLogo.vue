<script></script>
<template>
  <div class="v-logo-wrap flex justify-center items-center">
    ...
    <el-text class="v-logo-wrap-text" size="large" type="danger" tag="b">Figflix</el-text>
  </div>
</template>
<style lang="scss">
.v-logo-wrap {
  .v-logo-wrap-text.el-text {
    margin-left: 0.5rem;
    font-size: 32px;
  }
}
